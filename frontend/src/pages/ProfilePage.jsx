  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <div className="bg-white rounded-2xl border border-slate-200 shadow-xs overflow-hidden">
        ...
        <div className="h-28 bg-gradient-to-r from-indigo-600 via-indigo-700 to-slate-800 p-6 flex items-end">
          <div className="flex items-center gap-4 translate-y-8">
            <div className="w-16 h-16 rounded-2xl bg-white text-indigo-700 font-extrabold text-2xl flex items-center justify-center shadow-lg border-2 border-white">
              {user?.first_name ? user.first_name[0] : 'U'}
            </div>
            <div>
              <h2 className="text-lg font-bold text-slate-900">{user?.full_name || user?.email}</h2>
              <p className="text-xs text-slate-400 font-mono">{user?.employee_id}</p>
            </div>
          </div>
        </div>
        ...
        <div className="pt-12 p-6 sm:p-8">
          <form onSubmit={handleUpdate} className="space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 p-4 bg-slate-50 rounded-xl border border-slate-100">
              ...
              <div>
                <p className="text-xs text-slate-400 font-semibold uppercase">Designation</p>
                <p className="text-sm font-semibold text-slate-800 mt-1 flex items-center gap-1.5">
              ...
              <div>
                <p className="text-xs text-slate-400 font-semibold uppercase">Employment Status</p>
                <div className="mt-1">
